...
const routes: Routes = [
  ...
  { path: 'channels/:name', component: ChannelDetailsComponent },
  { path: 'admin/:id', component: ChannelDetailsComponent },
  { path: 'event/:country/:channel/:id', component: EventDetailsComponent },
  { path: 'bookmarks/event/:country/:channel/:id', component: EventDetailsComponent },
